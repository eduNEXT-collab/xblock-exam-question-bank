...
"""
xblock-exam-question-bank documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-exam-question-bank',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT-collab/xblock-exam-question-bank",
...
#
# html_title = 'xblock-exam-question-bank v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Exam Question Bank XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'examquestionbank'),
                os.path.join(root_path, 'examquestionbank/migrations')])
