#!/usr/bin/env python
"""
Package metadata for examquestionbank.
"""
import os
import re
import sys
...
VERSION = get_version('examquestionbank', '__init__.py')
...
setup(
    name='xblock-exam-question-bank',
    version=VERSION,
    description="""Exam Question Bank XBlock""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Edunext Project',
    author_email='heimdall@edunext.co',
    url='https://github.com/eduNEXT-collab/xblock-exam-question-bank',
    packages=find_packages(
        include=['examquestionbank', 'examquestionbank.*'],
        exclude=["*tests"],
    ),
