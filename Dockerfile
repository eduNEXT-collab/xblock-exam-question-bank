...
RUN mkdir -p /usr/local/src/xblock-exam-question-bank

# Set the created directory as a Docker volume
VOLUME ["/usr/local/src/xblock-exam-question-bank"]
...
RUN echo "pip install -r /usr/local/src/xblock-exam-question-bank/requirements.txt" >> /usr/local/src/xblock-sdk/install_and_run_xblock.sh && \
    echo "pip install -e /usr/local/src/xblock-exam-question-bank" >> /usr/local/src/xblock-sdk/install_and_run_xblock.sh && \
    echo "cd /usr/local/src/xblock-exam-question-bank && make compile_translations && cd /usr/local/src/xblock-sdk" >> /usr/local/src/xblock-sdk/install_and_run_xblock.sh && \
